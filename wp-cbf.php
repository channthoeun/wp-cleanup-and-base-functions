 ...
 *
 * @link              https://www.facebook.com/channthoeun.ken
 * @since             1.0.0
 * @package           Wp_Cbf
 *
 * @wordpress-plugin
 * Plugin Name:       WP Cleanup and base Functions
 * Plugin URI:        https://github.com/channthoeun/wp-cleanup-and-base-functions
 * Description:       This is a short description of what the plugin does. It's displayed in the WordPress admin area.
 * Version:           1.0.0
 * Author:            Channthoeun Ken
 * Author URI:        https://www.facebook.com/channthoeun.ken
 * License:           GPL-2.0+
